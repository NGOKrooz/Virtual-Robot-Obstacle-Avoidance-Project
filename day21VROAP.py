...
sensor_surface = pygame.Surface((800, 600), pygame.SRCALPHA)
...
# Sensor Settings
sensor_range = 30     #  Distance ahead to check
...
def detect_obstacle(pos, angle, walls):
    ...
    # Draw sensor line
    pygame.draw.line(sensor_surface, sensor_color, pos, sensor_end, 1)
